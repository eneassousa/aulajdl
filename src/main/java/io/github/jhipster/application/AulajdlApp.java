...
public class AulajdlApp {

    private static final Logger log = LoggerFactory.getLogger(AulajdlApp.class);

    private final Environment env;

    public AulajdlApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AulajdlApp.class);
